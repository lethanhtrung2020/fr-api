...
export default async (req, res) => {
  ...
  console.log('dt: ' + new Date('2020-09-20 11:31:21').toDateString() + ' - startDate: ' + new Date(sd === '' ? new Date() : sd.toString()) + ' - endDate: ' +  new Date(ed === '' ? new Date() : ed.toString()));
