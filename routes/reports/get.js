...
export default async (req, res) => {
  ...
  const lstLogs = await knex.select("l.*", "u.name", "u.icCard", "u.phone", "u.block_id", "u.company_id", "u.floor_id", "u.site_id", "d.type as dev_type", "b.name as block_name", "c.name as company_name", "f.name as floor_name", "s.name as site_name")
