...
export default async (req, res) => {
  ...
  console.log('device: ' + device + ' - type: ' + type + ' - site: ' + site + ' - block: ' + block + ' - floor: ' + floor + ' - comp: ' + comp + ' - sd: ' + sd + ' - ed: ' + ed);
