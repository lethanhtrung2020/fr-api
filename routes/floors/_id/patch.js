...
export default async (req, res) => {
  ...
  await knex('floors').where('id', id).where('short_name', sn).update({ short_name: shortName, name: name, description: description, created_date: knex.fn.now(),  updated_date: knex.fn.now() })
